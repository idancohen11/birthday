...
- "עוד שנה של לקום לעבודה ולעשות פוסטים על איך 'הכל בסדר' כשבפנים אתה מתפרק. תהנה מהעוגה 🎂"
- "שתזכה לפגישות שיהיו באמת דחופות, ומיילים שאף אחד לא קורא. או שלא 🥳"
- "גיל זה רק מספר – המספר האמיתי זה כמה שנים נשארו לך עד שתשבר לגמרי 😂"
- "שנה טובה להיות עייף 🎂"`;
